...
temp_rise(:,2) = censoring(temp_rise(:,1:3),p_para3(j-1,:),p_para4(j-1,:));
temp_rise(:,4) = censoring(temp_rise(:,[1 4:5]),p_para3(j-1,:),p_para4(j-1,:));
temp_rise(:,6) = censoring(temp_rise(:,[1 6:7]),p_para3(j-1,:),p_para4(j-1,:));
...
p_para2(j,1:10) = drchrnd(temp2(1,1:10),p_para2_hy(j-1,1),1);
p_para2(j,11:20) = drchrnd(temp2(1,11:20),p_para2_hy(j-1,2),1);
p_para3(j,1:8) = drchrnd(temp3(1,1:8),p_para3_hy(j-1,1),1);
p_para3(j,9:16) = drchrnd(temp3(1,9:16),p_para3_hy(j-1,2),1);
% p_para4(j,1:11) = drchrnd(temp4(1,1:11),p_para4_hy(j-1,1),1);
% p_para4(j,12:22) = drchrnd(temp4(1,12:22),p_para4_hy(j-1,2),1);

p_para4(j,1:11) = p_para4(j-1,1:11);
pro_para41 = drchrnd(temp4(1,1:11),p_para4_hy(j-1,1),1);
if pro_para41(1) < pro_para41(2) &&  pro_para41(2) < pro_para41(3) && pro_para41(3) < pro_para41(4);% && ...
  % pro_para41(4) < pro_para41(5) && pro_para41(5) < pro_para41(6);
p_para4(j,1:11) = pro_para41;
end;

p_para4(j,12:22) = p_para4(j-1,12:22);
pro_para42 = drchrnd(temp4(1,12:22),p_para4_hy(j-1,2),1);
if pro_para42(1) < pro_para42(2) &&  pro_para42(2) < pro_para42(3) && pro_para42(3) < pro_para42(4) && ...
   pro_para42(4) < pro_para42(5) && pro_para42(5) < pro_para42(6) && pro_para42(6) < pro_para42(7);
p_para4(j,12:22) = pro_para42;
end;
...
LL(j,1) = loglikelihood1(data_1,p_para1(j,:),cum_ILILAB,cutoff);
